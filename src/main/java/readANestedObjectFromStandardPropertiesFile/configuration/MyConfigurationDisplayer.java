...
public class MyConfigurationDisplayer implements ApplicationListener<ApplicationReadyEvent> {
	...
	public void onApplicationEvent(final ApplicationReadyEvent event) {
		System.out.println("Will display the 'myNestedObject.myString' value from the src/main/resources/application.properties file");
		System.out.println(myConf.getMyNestedObject().getMyString());
	}
}